...
| `themePrimary` | string | `'#0ea5e9'` | Primary action/doodle color; accepts hex, rgb, or common color names |
| `themeSecondary` | string | `'#6366f1'` | Secondary surface/background color for panels, containers, and soft fills |
